...
<template>
    <SelectValue data-slot="select-value-content" :placeholder="props.placeholder" :class="cn('flex min-w-0 flex-1 gap-1.5 text-left sm:gap-2', props.description ? 'items-start' : 'items-center', props.class)">
