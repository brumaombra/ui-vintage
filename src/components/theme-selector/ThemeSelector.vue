...
const themes = computed(() => [
    { id: 'light', label: t('ui.theme.light') },
    { id: 'dark', label: t('ui.theme.dark') },
    { id: 'auto', label: t('ui.theme.auto') }
]);
...
<template>
    <Popover v-model:open="isOpen">
        ...
        <PopoverTrigger as-child>
            <Button variant="secondary" size="icon" :aria-label="t('ui.theme.ariaLabel')">
        ...
        <PopoverContent side="bottom" align="end" :side-offset="8" class="w-44 !p-0">
            <Command :model-value="currentTheme">
                <CommandList>
                    <CommandGroup :heading="t('ui.theme.title')">
