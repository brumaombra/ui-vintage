            ...
            <div :class="cn('flex items-center', props.leftClass)">
                <slot name="left">
                    <a :href="props.appLinkTo" class="inline-flex items-center gap-2 transition-opacity hover:opacity-80">
                        <!-- App logo -->
                        <img v-if="props.appLogo" :src="props.appLogo" :alt="`${props.appName} logo`" width="44" height="44" loading="eager" fetchpriority="high" class="size-11 sm:size-9 shrink-0 object-contain" />
